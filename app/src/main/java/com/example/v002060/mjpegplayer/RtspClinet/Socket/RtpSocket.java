package com.example.v002060.mjpegplayer.RtspClinet.Socket;

import android.util.Log;

import com.example.v002060.mjpegplayer.RtspClinet.Stream.RtpStream;
import com.example.v002060.mjpegplayer.RtspClinet.Video.H264Stream;
...
public class RtpSocket implements Runnable {
    ...
    private byte[] message = new byte[65536];
    private int port;
    private String ip;
    ...
    private void startUdpReading() throws IOException {
        ...
        //Log.i("UdpReading", "Packet Size = " + mUdpPackets.getLength());
    ...
    public void setStream(H264Stream stream) {
        mRtpStream = stream;
    }

    ...
    private void H264PacketRecombine(StreamPacks streamPacks) {
        ...
        switch (nalType) {
            ...
            case NAL_UNIT_TYPE_STAP_A:
                Log.e(TAG, "Not implementation: NAL_UNIT_TYPE_STAP_A");
                break;

            //Single-timeaggregation packet
            case NAL_UNIT_TYPE_STAP_B:
                Log.e(TAG, "Not implementation: NAL_UNIT_TYPE_STAP_B");
                break;

            //Multi-time aggregationpacket
            case NAL_UNIT_TYPE_MTAP16:
                Log.e(TAG, "Not implementation: NAL_UNIT_TYPE_MTAP16");
                break;

            //Multi-time aggregationpacket
            case NAL_UNIT_TYPE_MTAP24:
                Log.e(TAG, "Not implementation: NAL_UNIT_TYPE_MTAP24");
                break;
            ...
            case NAL_UNIT_TYPE_FU_A:
                switch (packFlag) {
                    ...
                    case 0x40:
                        ...
                        break;
                    default:
                        Log.e(TAG, "Not implementation: packFlag = " + packFlag);
                        break;
                }
                break;
            ...
            case NAL_UNIT_TYPE_FU_B:
                Log.e(TAG, "Not implementation: NAL_UNIT_TYPE_FU_B");
                break;
